...
public class ParkingLotTest {
    ...
    void should_return_error_msg_when_smart_boy_fetch_given_a_used_ticket() {
        ...
        //Then
        assertThrows(RuntimeExceptionUnrecognizedParkingTicket.class, () ->
                smartParkingBoy.fetch(ticket), "Unrecognized parking ticket.");
    }
    ...
    //Story 6 Case 2
    @Test
    void should_park_in_2nd_when_supersmart_boy_park_given_2nd_has_more_available_positions() {
        //Given 2nd parking lot has more available positions
        SuperSmartParkingBoy superSmartParkingBoy = new SuperSmartParkingBoy(1, 10);
        Car car1 = new Car();
        Car car2 = new Car();
        //When
        ...
        //Then
        assertEquals(ticket.issuedParkingLot, superSmartParkingBoy.parkingLot2);
    }
    //Story 6 Case 3
    @Test
    void should_return_right_car_when_supersmart_boy_fetch_given_2_different_tickets() {
        //Given 2 parking lots with 1 position each
        ...
        assertEquals(car1, fetchedCar1);
        assertEquals(car2, fetchedCar2);
        assertEquals(ticket1.issuedParkingLot, superSmartParkingBoy.parkingLot1);
        assertEquals(ticket2.issuedParkingLot, superSmartParkingBoy.parkingLot2);
    }
    //Story 6 Case 4
    @Test
    void should_return_error_msg_when_supersmart_boy_fetch_given_a_unrecognized_ticket() {
        //Given
        SuperSmartParkingBoy superSmartParkingBoy = new SuperSmartParkingBoy(10, 10);
        Ticket wrongTicket = new Ticket();
        //When
        ...
        //Then
        assertThrows(RuntimeExceptionUnrecognizedParkingTicket.class, () ->
                superSmartParkingBoy.fetch(wrongTicket), "Unrecognized parking ticket.");
    }
    //Story 6 Case 5
    @Test
    void should_return_error_msg_when_supersmart_boy_fetch_given_a_used_ticket() {
        //Given
        SuperSmartParkingBoy superSmartParkingBoy = new SuperSmartParkingBoy(10, 10);
        Car car = new Car();
        Ticket ticket = superSmartParkingBoy.park(car);
